...
/**
 * @fileOverview A flow that summarizes long notes using AI.
 *
 * - summarizeNote - A function that summarizes a long note.
...
const SummarizeNoteInputSchema = z.object({
  note: z.string().describe('The long note to summarize.'),
});
